...
const Carousel = (props: {}) => {
  return (
    <section className="bg-neutral-dark mq450:gap-[99px_0px] mq750:gap-[99px_0px] mq750:pt-5 mq750:pb-[88px] mq750:box-border mq1100:pt-[31px] mq1100:pb-[135px] mq1100:box-border relative box-border flex max-w-full flex-col items-center justify-start gap-[99px_0px] self-stretch pb-52 pl-5 pr-[22px] pt-[0px]">
      ...
      <div className="absolute bottom-[-126px] left-[-150px] !m-[0] h-[1108px] w-[676px]">
        ...
        />
        <div className="bg-primary-colour absolute left-[399px] top-[826px] z-[1] h-[282px] w-[277px] rounded-[50%] [filter:blur(319.37px)]" />
      </div>
    </section>
  );
};
